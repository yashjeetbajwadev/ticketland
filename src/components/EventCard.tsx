...
export default function EventCard({ eventId }: { eventId: Id<"events"> }) {
  ...
  const renderQueuePosition = () => {
    ...
    if (queuePosition.position === 2) {
      return (
        <div className="flex flex-col items-center justify-between p-3 border rounded-lg lg:flex-row bg-amber-50 border-amber-100">
          <div className="flex items-center">
            <CircleArrowRight className="w-5 h-5 mr-2 text-amber-500" />
    ...
    return (
      <div className="flex items-center justify-between p-3 border border-blue-100 rounded-lg bg-blue-50">
        <div className="flex items-center">
          <LoaderCircle className="w-4 h-4 mr-2 text-blue-500 animate-spin" />
  ...
  const renderTicketStatus = () => {
      ...
      return (
        <div className="mt-4">
          <button
            ...
            className="flex items-center justify-center w-full gap-2 px-6 py-3 font-medium text-gray-700 transition-colors duration-200 bg-gray-100 rounded-lg shadow-sm hover:bg-gray-200"
          >
    ...
    if (userTicket) {
      return (
        <div className="flex items-center justify-between p-3 mt-4 border border-green-100 rounded-lg bg-green-50">
          <div className="flex items-center">
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex flex-col items-start gap-2">
              {isEventOwner && (
                <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-white rounded-full bg-blue-600/90">
