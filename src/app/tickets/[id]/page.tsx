    ...
    <div className="min-h-screen px-4 py-12 bg-gray-50 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <button className="flex items-center gap-2 px-4 py-2 text-gray-600 transition-colors rounded-lg hover:text-gray-900 hover:bg-gray-100">
        ...
        >
          ...
          >
            {ticket.event.is_cancelled
              ? "For questions about refunds or cancellations, please contact our support team at yashjeetbajwa8@gmail.com"
              : "If you have any issues with your ticket, please contact our support team at yashjeetbajwa8@gmail.com"}
          </p>
        </div>
      </div>
    </div>
